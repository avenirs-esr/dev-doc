...
**Date :** 05/03/2025<br/>
**Auteur :** A. Deman<br/>
**Commentaire :** Plan de mise en oeuvre à partir des [études préliminaire.](../arch-soft-specif-communication-preliminary-study.markdown){:target="_blank"}<br/>
<br/>

## Contexte
Dans un premier temps on laisse de côté le partie notification push mobile et la partie mail.<br/>
Les [expérimentations réalisées](../arch-soft-specif-communication-preliminary-study.markdown){:target="_blank"} autour du temps et des notifications servent de base à l'élaboration de l'architecture technique.
